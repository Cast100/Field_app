...
public class Expandablelist extends BaseExpandableListAdapter {
    ...
    public Expandablelist(Context context, List<MenuModel> listDataHeader, HashMap<MenuModel, List<MenuModel>> listDataChild) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.headerexpander, null);
        }

        TextView lblListHeader = convertView.findViewById(R.id.expands);
