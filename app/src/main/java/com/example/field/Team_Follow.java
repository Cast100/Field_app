...
public class Team_Follow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_team__follow);

        toolbar = (Toolbar) findViewById(R.id.tool_id);
        toolbar.setTitle("Follow Your Teams");
        ...
        mNextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Team_Follow.this,Player_Follow.class);
